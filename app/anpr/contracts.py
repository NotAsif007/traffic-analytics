...
class VehicleDetectionResult(AppBaseModel):
    ...
    vehicle_color: str | None = Field(None, examples=["white", "black", "silver"])
    crop_path: str | None = Field(None, description="Storage path to the cropped vehicle image")
    metadata_: dict[str, Any] | None = Field(default=None, alias="metadata")
...
class PlateDetectionResult(AppBaseModel):
    ...
    plate_crop_path: str | None = Field(None, description="Storage path to the cropped plate image")
    plate_region: str | None = Field(
        None, description="Predicted country/state code (e.g. KA, MH, IN)"
    )
    metadata_: dict[str, Any] | None = Field(default=None, alias="metadata")
...
class OCRResult(AppBaseModel):
    ...
    model_name: str | None = Field(None, examples=["paddleocr-v4", "crnn-v1"])
    metadata_: dict[str, Any] | None = Field(default=None, alias="metadata")
...
class ObservationCandidate(AppBaseModel):
    ...
    plate_detection: PlateDetectionResult | None = None
